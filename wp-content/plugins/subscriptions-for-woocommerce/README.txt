...
== WHAT’S INCLUDED IN OUR FREE SUBSCRIPTIONS FOR WOOCOMMERCE PLUGIN ==
...
**4) Subscription Plan Expiry Choice**
...
If you want to charge extra payment in the form of an initial sign-up fee, you can do that too. The free Subscriptions for WooCommerce plugin support the Stripe payment integration of WooCommerce. This integration works seamlessly together.
...
* [**Subscriptions for WooCommerce Backend Demo**](https://demo.wpswings.com/subscriptions-for-woocommerce-pro/request-for-personal-demo/?utm_source=wpswings-subs-demo&utm_medium=subs-org-page&utm_campaign=backend-demo)

== PLUGIN COMPATIBILITIES ==

*  [**Membership for WooCommerce Free**](https://wordpress.org/plugins/membership-for-woocommerce/) and [**Membership for WooCommerce Pro**](https://wpswings.com/product/membership-for-woocommerce-pro/?utm_source=wpswings-subs-membership-pro&utm_medium=subs-org-page&utm_campaign=membership-pro)
...
* Supports all the above-mentioned compatibility along with [**Ultimate Gift Cards for WooCommerce**](https://wordpress.org/plugins/woo-gift-cards-lite/), [**Wallet System for WooCommerce Pro**](https://wpswings.com/product/wallet-system-for-woocommerce-pro/?utm_source=wpswings-wallet-pro&utm_medium=subs-org-page&utm_campaign=wallet-pro/).
...
If you need support or have any questions then kindly use our online chat window [**here**](https://wpswings.com/?utm_source=wpswings-subs-here&utm_medium=subs-org-page&utm_campaign=here) or  connect with us then or  connect with us then [**Generate a Ticket**](https://wpswings.com/submit-query/?utm_source=wpswings-subs-query&utm_medium=subs-org-page&utm_campaign=query)
...
Automatic installation is the easiest option as WordPress handles the file transfers itself and you don't need to leave your web browser. To do an automatic install of Subscriptions  For WooCommerce, log in to your WordPress dashboard, navigate to the Plugins menu, and click Add New.
...
= Do Subscriptions for WooCommerce plugins support recurring payment for a subscription-type product? =

Yes, Admin needs to configure the WooCommerce Stripe plugin to support recurring payments on your site.
...
= Can Admin check the report of subscriptions? =

Yes, Admin can check the status of all his subscriptions like active and inactive subscriptions, next payment dates, product names, subscription expiry dates, renewal dates.
...
Yes, the admin can set the expiration date for any type of subscription in days, weeks, months & years.

= Can Admin provide a free trial to customers for a subscription? =

Yes, Admin can provide a feature to give the free trial to customers, for which the admin can set the maximum trial days after which the subscription for that product will get started.
...
No, the customer can only add a single subscription in the cart in the free plugin. If you want to add multiple subscriptions to the cart, kindly check our pro plugin [**WooCommerce Subscriptions**](https://wpswings.com/product/subscriptions-for-woocommerce-pro/?utm_source=wpswings-subscriptions-org&utm_medium=wpswings-org-page&utm_campaign=subscriptions-pro). Our Subscription for WooCommerce pro plugin allows customers to add multiple subscriptions to the cart at once.

= Can the client add multiple subscriptions to the cart? =

This is not possible in the free plugin, the client can add multiple subscriptions in the cart in our Subscriptions for WooCommerce Pro plugin

= Do we have any premium or paid version of the WooCommerce Subscription Management plugin? =

Yes, we have our Premium Version of [**Subscriptions for WooCommerce Pro**](https://wpswings.com/product/subscriptions-for-woocommerce-pro/?utm_source=wpswings-subs-pro&utm_medium=subs-org-page&utm_campaign=subscription-pro) to manage subscriptions with many features.

= Is this Subscription plugin working with the variable products too? =

 No, in the free plugin it will only work with the simple product but in the pro version of Subscriptions for WooCommerce, it will work with simple and pro both.
